...
library(rgdal)
library(spData)
point_file<-st_read("Z:/PROCESS/ISMN/STATION_SHAPE/ISMN_STATIONS_final_GCS84_slope_SD_TIER1.gpkg")
...
st_write(point_file2,"Z:/PROCESS/ISMN/STATION_SHAPE/ISMN_finalGCS84_staticvalue_TIER2.gpkg")
write.csv(point_file2,"Z:/PROCESS/ISMN/STATION_SHAPE/ISMN_finalGCS84_staticvalue_TIER2.csv")
save(point_file2,file="Z:/PROCESS/ISMN/STATION_SHAPE/ISMN_finalGCS84_staticvalue_TIER2.RData")
